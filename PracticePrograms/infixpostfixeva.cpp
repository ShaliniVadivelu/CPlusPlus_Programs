...
int main() 
{  
  	string infix_exp, postfix_exp,postfix_eval;
	...
	//cout<<"Infix Expression: "<<infix_exp<<endl;
  	postfix_exp = infixToPostfix(stack, infix_exp);	//calling the function by passing stack and infix expression.
  	//cout<<"Postfix Expression: "<<postfix_exp<<endl;	
	//postfix_eval=postfixEvaluation(postfix_exp);
	//cout<<"Final answer of postfix expression: "<<postfixEvaluation(postfix_exp);
	cout<<postfixEvaluation(postfix_exp);
